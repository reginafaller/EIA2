namespace L04_AssocArraysAndExport {
    ...
    export let data: HomogenousArray
		...
		"sahne": [
			...
			{type:"radio", name:"sahne", value:0, id:"radio1", class:"Laktosefreie Sahne", step:0, min:0, max:0, price:1},
			{type:"radio", name:"sahne", value:0, id:"radio2", class:"Sahne",step:0, min:0, max:0, price:1.2}
		],
		"Anrichtung": [
			{type:"radio", name:"anricht", value:0, id:"radio3", class:"In Waffel", step:0, min:0, max:0, price:1.5},
			{type:"radio", name:"anricht", value:0, id:"radio4", class:"Im Becher", step:0, min:0, max:0, price:1},
		],
		"Extras": [
